...
export default {
  ...
  'Depicted/Represented place': 'Ort',
  'Depicted/Represented place (native name)': 'Ort einheimisch',
  ...
  'HOME_SANDBOX': 'Zum Testen steht Ihnen im Universitätsnetz eine {0} von Phaidra zur Verfügung.',
