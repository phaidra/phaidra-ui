...
export default {
  ...
  'SUBMIT_START_2': 'Bitte beachten Sie, dass ein Upload von Dokumenten nach u:scholar nur erlaubt ist, {0} (z.B. seitens des Verlages oder anderer Rechteinhaber)!',
  'if you hold the necessary rights': 'wenn Sie dafür entsprechende Rechte haben',
  'SUBMIT_START_3': 'Planen Sie eine {0} hochzuladen, {1} Sie uns bitte vorher.',
  'a larger number of publications': 'größere Anzahl an Publikationen',
  'contact us': 'kontaktieren',
  'SUBMIT_START_4': 'Damit Ihre KollegInnen die Datei umstandslos lesen können, laden Sie nach Möglichkeit bitte eine PDF-Version hoch.',
  'SUBMIT_START_5': 'Wenn die von Ihnen hochzuladende Datei die Größe von 500MB überschreitet, wenden Sie sich bitte an {0}.',
  'SUBMIT_START_6': 'Sollten Sie Fragen haben, lesen Sie bitte zunächst, was wir auf diesen Seiten über {0} schreiben. Unter {1} helfen Ihnen MitarbeiterInnen der Universitätsbibliothek gern weiter.',
  'Terms of use': 'Nutzungsbedingungen',
  'SUBMIT_TOU_1': 'Die durch den Publikationsservice u:scholar zugänglichen Dokumente und Materialien sowie dazugehörige Abstracts unterliegen dem geltenden Urheberrechtsgesetz und können zu wissenschaftlichen und privaten Zwecken frei verwendet werden. Es können jeweils unterschiedliche Nutzungsbefugnisse gelten, die den Dokumenten und Materialien sowie Abstracts zugeordnet sind.',
  ...
  'Type of publication': 'Erscheinungsform',
  'Version type': 'Version',
  'Access right': 'Zugriffsrechte',
  'Check rights': 'Rechte prüfen',
  'please enter exact journal title or ISSN': 'bitte exakten Zeitschriftentitel oder ISSN eingeben',
