        ...
        <v-dialog class="pb-4" v-model="templateDialog" width="700px">
          <template v-slot:activator="{ on }">
            <v-btn v-on="on" large dark color="grey">
              <v-icon dark class="mr-4">mdi-script</v-icon> {{ $t("Template submit") }}
            </v-btn>
          </template>
          <v-card>
    ...
    <v-row class="my-6" justify="start">
      <v-col cols="12">
        ...
        <v-btn large dark color="grey white--text mr-8" :to="{ name: 'submit-empty' }">
          <v-icon dark class="mr-4">mdi-script-outline</v-icon> {{ $t("Empty") }}
        </v-btn>
      </v-col>
    </v-row>
    <v-divider></v-divider>
    <v-row class="my-6" justify="start">
      <v-col cols="12">
        <v-btn large dark color="grey white--text" :to="{ name: 'submit-uwm' }">
          <v-icon dark class="mr-4">mdi-history</v-icon> {{ $t("Legacy submit") }}
        </v-btn>
      </v-col>
    </v-row>
  </v-container>
